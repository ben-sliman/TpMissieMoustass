...
public class AdminUtilisateur extends JFrame {
    ...
    private void addUser() {
        ...
        if (!validerEmail(email)) {
            JOptionPane.showMessageDialog(this, "Adresse email invalide.", "Erreur",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        int option = JOptionPane.showConfirmDialog(null, confirmPasswordField,
                "Confirmez le mot de passe", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
        ...
        if (option == JOptionPane.OK_OPTION) {
            ...
            JOptionPane.showMessageDialog(this, "Opération annulée.", "Annulation",
